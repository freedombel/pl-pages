...
- у выпадку, калі дзеянне art. 252a **не будзе падоўжана для беларусаў пасля 30 чэрвеня 2024 года**, падавацца можна будзе **толькі на падставе агульнага art. 252 ustawa o cudzoziemcach[^2]** (часовы побыт на падставе міжнароднай аховы, часовы побыт па арт. 186 - на падставе гуманітарнай візы, побыт сталы/рэзідэнт, побыт гуманітарны - не блытаць з побытам па гуманітарнай візе_)
...
- запоўнены wniosek (_актуальную версію лепей за ўсё браць са старонкі Urzędu do Spraw Cudzoziemców[^3], бо на старонках ужондаў ён не заўжды можа быць актуальны_)
...
- у раздзеле, у рамцы, F подпіс уласнаручна ставіць той, каму **прызначаецца падарожны дакумент** (_у выпадку з непаўнагадовым - ставіць непаўнагадовы і_ **_толькі ён,_** _калі яму_ **_споўнілася 13 гадоў_**_, калі меньш - застаўляем поле пустым_)
...
- калі ў вас няма дадзеных да лагавання на Portal Klienta[^7], можна праз запытаць іх праз email `cudzoziemcy.pobyt@gdansk.uw.gov.pl`, прыклад:
...
- спіс польскіх аэрапартоў, авіяперавозчыкаў і краінаў (як у зоне Шэнген, так і іншыя) і як яны працуюць альбо не працуюць з польскім падарожным дакументам[^12]
